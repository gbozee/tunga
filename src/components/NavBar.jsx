...
class NavBar extends React.Component {
  ...
  onSearch(query) {
    ...
    if (!SEARCH_PATH.test(this.props.location.pathname)) {
      ...
      const replacer = this.props.replaceFunc(router);
      replacer("/search");
    }
  }
          ...
          <div id="navbar" className="navbar-collapse collapse">
            <ul className="nav navbar-nav navbar-right">
              <li id="navbar-search">
                <SearchBox
                  placeholder="Search"
                  query={this.props.queryFunc(this.props.location,'q')}
                  hide_results={true}
                  ...
                  <ul className="dropdown-menu">
                    ...
                    <li>
                      <Link to="/people/invite">
                        <i className="nav-icon fa fa-user-plus" /> Invite Users
                      </Link>
                    </li>
                    <li>
                      <Link to="/dashboard/updates">
                        <i className="nav-icon fa fa-bell" /> Updates dashboard
                      </Link>
                    </li>
                  </ul>
                </li>
              ...
              <li className="dropdown" id="navbar-account">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <Link to="/profile">
                      <i className="nav-icon tunga-icon-profile" /> My Profile
                    </Link>
                  </li>
                  <li>
                    <Link to="/settings">
                      <i className="nav-icon tunga-icon-settings" /> Settings
                    </Link>
                  </li>
                  <li role="separator" className="divider" />
                  <li>
                    <Link to="" onClick={this.handleLogout}>
                      <i className="nav-icon tunga-icon-sign-out" /> Sign Out
                    </Link>
                  </li>
                </ul>
              </li>
